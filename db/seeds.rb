...
user1 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user2 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
user3 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user4 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
user5 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user6 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
user7 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user8 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
user9 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user10 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
user11 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user12 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
user13 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user14 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
user15 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user16 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
user17 = User.create(name: "Aaron Kim", username: "Ayayron", bio: "Looking for a coach", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244242)
user18 = User.create(name: "Brooke Bachman", username: "Bachmanity", bio: "Looking for a diet", password: "test", password_confirmation: "test", url: "", img: "", phone: 4154244352)
...
coach1 = Coach.create(user_id: user3.id, trainer_id: user15.id )
coach2 = Coach.create(user_id: user4.id, trainer_id: user3.id )
coach3 = Coach.create(user_id: user5.id, trainer_id: user3.id )
coach4 = Coach.create(user_id: user6.id, trainer_id: user3.id )
coach5 = Coach.create(user_id: user7.id, trainer_id: user4.id )
coach6 = Coach.create(user_id: user8.id, trainer_id: user5.id )
coach7 = Coach.create(user_id: user3.id, trainer_id: user14.id )
coach8 = Coach.create(user_id: user3.id, trainer_id: user13.id )
coach9 = Coach.create(user_id: user3.id, trainer_id: user4.id )
coach10 = Coach.create(user_id: user4.id, trainer_id: user5.id )
coach11 = Coach.create(user_id: user4.id, trainer_id: user12.id )
coach12 = Coach.create(user_id: user4.id, trainer_id: user11.id )
coach13 = Coach.create(user_id: user5.id, trainer_id: user12.id )
coach14 = Coach.create(user_id: user5.id, trainer_id: user3.id )
coach15 = Coach.create(user_id: user5.id, dietitian_id: user4.id )
coach16 = Coach.create(user_id: user6.id, dietitian_id: user15.id )
coach17 = Coach.create(user_id: user7.id, dietitian_id: user14.id )
coach18 = Coach.create(user_id: user8.id, dietitian_id: user13.id )
coach19 = Coach.create(user_id: user9.id, dietitian_id: user12.id )
coach20 = Coach.create(user_id: user10.id, dietitian_id: user11.id )
coach21 = Coach.create(user_id: user11.id, dietitian_id: user10.id )
coach22 = Coach.create(user_id: user12.id, dietitian_id: user9.id )
coach23 = Coach.create(user_id: user13.id, dietitian_id: user8.id )
coach24 = Coach.create(user_id: user14.id, dietitian_id: user7.id )
coach25 = Coach.create(user_id: user15.id, dietitian_id: user6.id )
...
workout2 = Workout.create(title: "p90x", content_type: "Workout", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user1.id)
workout3 = Workout.create(title: "Killer Upper Body", content_type: "Workout", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user1.id)
workout4 = Workout.create(title: "Bikini Body", content_type: "Workout", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user2.id)
workout5 = Workout.create(title: "Core de Force!", content_type: "Workout", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user2.id)

workout6 = Workout.create(title: "Paleo!", content_type: "Diet", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user2.id)
workout7 = Workout.create(title: "Whole 30!", content_type: "Diet", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user1.id)
workout8 = Workout.create(title: "Atkins!", content_type: "Diet", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user1.id)
workout9 = Workout.create(title: "Mediterranean", content_type: "Diet", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user2.id)
workout10 = Workout.create(title: "Dash", content_type: "Diet", content_link: "www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user2.id)

review1 = Review.create(user_id: user5.id, workout_id: workout1.id, text: "What a workout!")
review2 = Review.create(user_id: user4.id, workout_id: workout2.id, text: "Awesome awesome awesome")
review3 = Review.create(user_id: user3.id, workout_id: workout3.id, text: "I've lost so much weight!")
review4 = Review.create(user_id: user7.id, workout_id: workout4.id, text: "This is the best!")
review5 = Review.create(user_id: user8.id, workout_id: workout5.id, text: "Life Changing")
review6 = Review.create(user_id: user4.id, workout_id: workout5.id, text: "Recommending this to my family")
# rail

pump1 = Pump.create(user_id: user5.id, workout_id: workout1.id)
# pump2 = Pump.create(user_id: user4.id, workout_id: workout2.id)
# pump3 = Pump.create(user_id: user3.id, workout_id: workout3.id)
# pump4 = Pump.create(user_id: user3.id, workout_id: workout4.id)
# pump5 = Pump.create(user_id: user9.id, workout_id: workout4.id)
# pump6 = Pump.create(user_id: user3.id, workout_id: workout4.id)
# pump7 = Pump.create(user_id: user4.id, workout_id: workout5.id)
# pump8 = Pump.create(user_id: user15.id, workout_id: workout5.id)
# pump9 = Pump.create(user_id: user6.id, workout_id: workout5.id)
# pump10 = Pump.create(user_id: user7.id, workout_id: workout5.id)
# pump11 = Pump.create(user_id: user13.id, workout_id: workout6.id)
# pump12 = Pump.create(user_id: user5.id, workout_id: workout7.id)
# pump13 = Pump.create(user_id: user9.id, workout_id: workout7.id)
# pump14 = Pump.create(user_id: user14.id, workout_id: workout7.id)
# pump15 = Pump.create(user_id: user12.id, workout_id: workout7.id)
# pump16 = Pump.create(user_id: user11.id, workout_id: workout8.id)
# pump17 = Pump.create(user_id: user7.id, workout_id: workout9.id)
# pump18 = Pump.create(user_id: user5.id, workout_id: workout10.id)
# pump19 = Pump.create(user_id: user2.id, workout_id: workout11.id)
# pump20 = Pump.create(user_id: user3.id, workout_id: workout11.id)
# pump21 = Pump.create(user_id: user8.id, workout_id: workout11.id)
# pump22 = Pump.create(user_id: user10.id, workout_id: workout10.id)
# pump23 = Pump.create(user_id: user11.id, workout_id: workout9.id)
# pump24 = Pump.create(user_id: user8.id, workout_id: workout8.id)
# pump25 = Pump.create(user_id: user7.id, workout_id: workout8.id)
# pump26 = Pump.create(user_id: user6.id, workout_id: workout1.id)
