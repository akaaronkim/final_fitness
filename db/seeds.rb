...
coach15 = Coach.create(user_id: user5.id, trainer_id: user4.id )
coach16 = Coach.create(user_id: user6.id, trainer_id: user15.id )
coach17 = Coach.create(user_id: user7.id, trainer_id: user14.id )
coach18 = Coach.create(user_id: user8.id, trainer_id: user13.id )
coach19 = Coach.create(user_id: user9.id, trainer_id: user12.id )
coach20 = Coach.create(user_id: user10.id, trainer_id: user11.id )
coach21 = Coach.create(user_id: user11.id, trainer_id: user10.id )
coach22 = Coach.create(user_id: user12.id, trainer_id: user9.id )
coach23 = Coach.create(user_id: user13.id, trainer_id: user8.id )
coach24 = Coach.create(user_id: user14.id, trainer_id: user7.id )
coach25 = Coach.create(user_id: user15.id, trainer_id: user6.id )
...
review7 = Review.create(user_id: user13.id, workout_id: workout6.id, text: "My butt is looking great!")
review8 = Review.create(user_id: user8.id, workout_id: workout7.id, text: "You can wash your clothes on my abs!")
review9 = Review.create(user_id: user11.id, workout_id: workout8.id, text: "Trainer looks like a creep, and he is one.")
review10 = Review.create(user_id: user12.id, workout_id: workout9.id, text: "Didn't think my body could do that. ")
