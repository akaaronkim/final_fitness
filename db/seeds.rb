...
user1 = User.create(name: "Aaron Kim", username: "Ayayron", about_me: "Looking for a coach", password: "test", password_confirmation: "test")
user2 = User.create(name: "Brooke Bachman", username: "Bachmanity", about_me: "Looking for a diet", password: "test", password_confirmation: "test")
...
workout1 = Workout.create(title: "Ultra Ironman!", content_type: "Workout", content_link: "https://www.https://www.outsideonline.com/1856916/9-toughest-ultramarathons", user_id: user2.id)
